...
public class RegisterRecipes
{
	...
	public static void addAdvancedRecipes()
	{
		AdvancedCraftingHandler.addAdvancedRecipe(new ItemStack(Items.diamond_pickaxe), new ItemStack[] {
			new ItemStack(Items.redstone, 3), new ItemStack(Items.blaze_powder, 2) }, "DDD", " / ", " / ",
	...
	public static void addShapedRecipes()
	{
		...
		GameRegistry.addShapedRecipe(new ItemStack(RegisterItems.boneKnife), "S ", " /", 'S',
			RegisterItems.boneShard, '/', Items.bone);
		GameRegistry.addShapedRecipe(new ItemStack(RegisterItems.ironKnife), "/ ", " I", '/', Items.stick,
			'I', Items.iron_ingot);
		GameRegistry.addShapedRecipe(new ItemStack(RegisterItems.ironKnife), " /", "I ", '/', Items.stick,
			'I', Items.iron_ingot);
		...
		// Bone Pickaxe
		GameRegistry.addShapedRecipe(new ItemStack(RegisterItems.bonePickaxe), "BLB", " / ", " / ", 'B',
			RegisterItems.boneShard, 'L', RegisterItems.leatherStrip, '/', Items.stick);
